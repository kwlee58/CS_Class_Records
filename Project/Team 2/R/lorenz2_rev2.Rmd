...
# ggtitle("각 나라별 로렌츠곡선 비교 ") + labs(colour="나라") + scale_colour_discrete(labels = c("알바니아", "브라질", "한국", "저불평등", "멕시코", "완전평등선", "우간다"))
(I.W.5 <- I.W.4 + theme.kr + xlab("누적인구비율(%)") + ylab("누적 소득률(%)") +
...
```{r}
# (I.W.6 <- I.W.5 + labs(colour="나라") +scale_colour_discrete(labels = c("알바니아", "브라질","한국","저불평등","멕시코","완전평등선","우간다")))
```
