...
library(xlsx)
# data0 <- read.xlsx("data1.xlsx", 1, startRow=3, endRow=32, colIndex=3:7, header=FALSE)
data0 <- read.xlsx("data1.xlsx", 1, startRow=3, endRow=32, colIndex=3:7, colClasses=rep("numeric", 5), header=FALSE)
data0
# data1 <- read.xlsx("data1.xlsx", 1, startRow=3, endRow=32, colIndex=3:7,  header=FALSE)
...
# data5
# data6 <- data5[-22,]
# mapply(str, list(data2, data3, data4, data5, data6))
...
# datadown1 <- read.xlsx("data1.xlsx", 1, startRow=3, endRow=32, colIndex=2,   header=FALSE)
datadown1
datadown6 <- datadown1[-c(1, 9, 11, 23, 26), ]
...
하위 정리를 끝내면 상위를 정리한다.
```{r}
# dataup1 <- read.xlsx("data1.xlsx", 1, startRow=3, endRow=32, colIndex=8,  header=FALSE)
dataup1 <- read.xlsx("data1.xlsx", 1, startRow=3, endRow=32, colIndex=8, colClasses="numeric", header=FALSE)
dataup1
dataup6 <- dataup1[-c(1, 9, 11, 23, 26), ]
# dataup2 <-dataup1[-1,]
# dataup2
# dataup3 <-dataup2[-8]
# dataup3
...
newdata6
mapply(dim, list(newdata6, dataup8))
...
## Brazil
lines(x=x,y=y20, col="pink") 
##Albania
lines(x=x,y=y25,col="purple") 
## Uganda
title(main="각 나라 로렌츠 곡선 비교",xlab="People Cumulated",ylab="Income Cumulated")
legend(x=5,y=95, legend=c("low","Korea","Mexico","Brazil","Albania","Uganda"),lty=1,col=c("black","blue","cyan","gray","purple"),title="income inequality")
